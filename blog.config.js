...
const BLOG = {
  ...
  THEME_SWITCH: (() => {
  const envVal = process.env.NEXT_PUBLIC_THEME_SWITCH;
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'luckylotus', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个努力上进的学习者💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.luckylotus.top/', // 网站地址
